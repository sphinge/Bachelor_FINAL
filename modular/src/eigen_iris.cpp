// g++ eigen_iris.cpp utils.cpp -I/usr/include/eigen3  -o iris
...
std::ofstream acc_file("../plots/iris_plots/acc_iris_un_0.csv");
std::ofstream conf_file("../plots/iris_plots/confusion_iris_un_0.csv");
...
int main()
{
    ...
    string filename_train = "../data/train_iris_norm_0.csv"; // Replace with your CSV file name
    int numFeatures = 4;                                      // Number of features for breast cancer
    ...
    string filename_test = "../data/test_iris_norm.csv"; // Replace with your CSV file name
