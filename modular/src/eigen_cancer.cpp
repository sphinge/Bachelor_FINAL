// g++ eigen_cancer.cpp utils.cpp -I/usr/include/eigen3  -o cancer
...
std::ofstream acc_file("../plots/breast_cancer_plots/acc_breast_cancer_un_1.csv");
std::ofstream conf_file("../plots/breast_cancer_plots/confusion_breast_cancer_un_1.csv");
...
int main()
{
    ...
    string filename_train = "../data/train_breast_cancer_norm_1.csv"; // Replace with your CSV file name
    int numFeatures = 30;                                      // Number of features for breast cancer
    ...
    string filename_test = "../data/test_breast_cancer_norm.csv"; // Replace with your CSV file name
