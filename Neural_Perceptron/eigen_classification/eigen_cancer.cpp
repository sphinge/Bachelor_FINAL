// g++ eigen_cancer.cpp -I/usr/include/eigen3  -o cancer
...
pair<MatrixXd, MatrixXd> readCSV(const string &filename, int numFeatures, int numLabels)
{
    ...
    for (int i = 0; i < numRows; ++i)
    {
        ...
        int labelIndex = static_cast<int>(data[i][0]);
        y(i, labelIndex) = 1.0;

        // Subsequent values are features
...
int main()
{
    ...
    string filename_train = "../data/cancer_train.csv"; // Replace with your CSV file name
    ...
    string filename_test = "../data/cancer_test.csv"; // Replace with your CSV file name
