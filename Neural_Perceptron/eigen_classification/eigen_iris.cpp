// g++ eigen_iris.cpp -I/usr/include/eigen3  -o iris
...
int main()
{
    ...
    string filename_train = "../data/iris.csv"; // Replace with your CSV file name
    ...
    string filename_test = "../data/iris_test.csv"; // Replace with your CSV file name
