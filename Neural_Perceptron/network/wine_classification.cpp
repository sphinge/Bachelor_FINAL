//g++ -o wine wine_classification.cpp
#include <vector>
#include <cmath>
#include <iostream>
...
std::ofstream loss_file("wine_plots/loss.csv");
std::ofstream predict_file("wine_plots/predictions.csv");
...
int main()
{
    ...
    vector<int> nNeuronsEachLayer = {13, 8, 3}; // Assuming 13 input features and 3 output classes
    ...
    while (getline(file, line))
    {
        ...
        // Read first 13 values as features
        for (int i = 0; i < 13; ++i)
        {
            getline(ss, value, ',');
    ...
    ifstream test_file("../data/wine_test.csv");
    //ifstream test_file("wine_test.csv");
